...
export default function RestaurantTable() {
    ...
    useEffect(() => {
        axios.get("/api/restaurants/all").then((response) => {
    ...
    useEffect(() => {
        const fetchseries = async () => {
            const result = await axios(`/api/series/all`);
    ...
    return (
        ...
        <div className="table-responsive  ">
            <h2 className="table mt-5 text-center">Liste des Restaurants</h2>
                    ...
                    {currentPageItems.map((restaurant) => (
                        <tr key={restaurant.id}>
                            ...
                            <td>
                                ...
                                <Link className="btn btn-link ml-2" to={`/mapresto/${restaurant.id}`} >
                                Map
                                </Link>
                            </td>
                        </tr>
